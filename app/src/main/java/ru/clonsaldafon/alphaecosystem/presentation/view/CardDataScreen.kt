...
import ru.clonsaldafon.alphaecosystem.presentation.component.DataItem
    ...
    Column(
        ...
        Column(
            ...
            Column(
                ...
                DataItem(
                    text = "Country",
                    data = uiState.card?.country
                )

                DataItem(
                    text = "Coordinates",
                    data = uiState.card?.coordinates
                )

                DataItem(
                    text = "Type",
                    data = uiState.card?.type
                )

                DataItem(
                    text = "Website",
                    data = uiState.card?.website
                )

                DataItem(
                    text = "Phone",
                    data = uiState.card?.phone
                )

                DataItem(
                    text = "City",
                    data = uiState.card?.city
                )
            }
        }
    }
